...
<body>
  ...
  <div class="container1-3">
    <div class="rov1-2">
      <div class=" col- col-12 col-s-12 col-l-12 col-xl-12">
        <div id="text1">
        Sveiki, esu fotografė Reda. Man fotografija - tai sustojusi akimirka, kurioje įamžintos emocijos, kelia nuostabius prisiminimus ir padaro įvykius nepamirštamus. Laiko niekas nesustabdys, o jam bėgant, daugelis prisiminimų, net labai svarbių, išblėsta, nuostabios akimirkos užsimiršta, bet fotografijos stebūklas leidžia praeities akimirkoms išlikti.Esu laiminga, nes galiu užfiksuoti svarbiausias akimirkas, sugauti natūralias šypsenas, padėti žmonėms atsiskleisti ir savo darbu dovanoti Jums džiaugsmą. Su geriausiais linkėjimais!Reda
        </div>
      </div>
    </div>
  </div>
  <div class="container2">
    <div class="row2">
      <div class="col- col-12 col-s-10 col-l-12 col-xl-12">
        <div class="">
          <img src="images/rsz_117.jpg" alt="">
        </div>
        <div class="">
          <img src="images/Optimized-VILNIUS3-compressor.jpg" alt="">
        </div>
        <div class="">
          <img  src="images/rsz_1110.jpg" alt="">
        </div>
        <div class="">
          <img src="images/rsz_24.jpg" alt="">
        </div>
      </div>
    </div>
  </div>
