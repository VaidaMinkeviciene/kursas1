    ...
    <div class="container2">
      <div class="row2">
        <div class="col- col-12 col-s-10 col-l-12 col-xl-12">
          <div class="">
            <a href="gallery/index.html"><img src="images/vestuves.jpeg" alt="Vestuvių nuotraukos"></a>
          </div>
          <div class="">
            <a href="gallery0/index.html"><img src="images/krikstynos.jpeg" alt="Vaikų šventės"></a>
          </div>
          <div class="">
            <a href="gallery1/index.html"><img  src="images/portretas.jpeg" alt="Portretai"></a>
          </div>
          <div class="">
            <a href="gallery2/index.html"><img src="images/gamta.jpeg" alt="Gamta"></a>
          </div>
        </div>
      </div>
    </div>
