...
<head>
  ...
  <body>
    ...
    <div class="container1-2">
      <div class="rov1-2">
        <div class=" col- col-12 col-s-12 col-l-12 col-xl-12">
          <div id="tekstas" class="text3">
            <table>
              <tr>
                <td>
                  6 valandų fotografavimas vestuvių dieną jūsų pasirinktu laiku;
                  Nuotraukų sutvarkymas ir paruošimas iki 3 mėnesių;
                  Ne mažiau 200 sutvarkytų nuotraukų;
                  Fotofilmas su jūsų pasirinkta daina;
                  Apipavidalintas USB raktas  su nuotraukomis.
                  10 atspausdintų nuotraukų 10×15 formato.
                  Prieš vestuvinė (lovestory) fotosesija
                  – Jūsų susipažinimo istorija arba sugalvotas siužetas;
                  – pateikiama fotofilmo ir nuotraukų pavidale;
                </td>
                <td>Avansas: 200 EUR</td>
                <td>Kaina: 500 EUR</td>
              </tr>
              <tr>
                <td>
                  8 valandų fotografavimas vestuvių dieną jūsų pasirinktu laiku;
                  Nuotraukų sutvarkymas ir paruošimas iki 3 mėnesių;
                  Ne mažiau 300 sutvarkytų nuotraukų;
                  Fotofilmas su jūsų pasirinkta daina;
                  Apipavidalintas USB raktas  su nuotraukomis.
                  10 atspausdintų nuotraukų 10×15 formato.
                  Prieš vestuvinė (lovestory) fotosesija
              ...
              <tr>
                <td>
                  10 valandų fotografavimas vestuvių dieną jūsų pasirinktu laiku;
                  Nuotraukų sutvarkymas ir paruošimas iki 3 mėnesių;
                  Ne mažiau 400 sutvarkytų nuotraukų;
                  Fotofilmas su jūsų pasirinkta daina;
                  Apipavidalintas USB raktas  su nuotraukomis.
                  10 atspausdintų nuotraukų 10×15 formato.
                ...
                <td>Avansas 300 EUR</td>
                <td>Kaina 700 EUR</td></tr>
              </table>
            </div>
          </div>
        </div>
